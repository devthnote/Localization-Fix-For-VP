/* (1) Community Patch/Core Files/Text/CoreText_es_ES.sql */
  ...
  VALUES		('TXT_KEY_GAME_OPTION_BARB_GG_GA_POINTS',		'Habilitar puntos GG/GA de bárbaros'),
        ('TXT_KEY_GAME_OPTION_BARB_GG_GA_POINTS_HELP',	'Permite a todos los jugadores acumular puntos para Grandes Generales y Almirantes al luchar contra bárbaros');
        
  UPDATE Language_es_ES
  SET Text = 'Cada vez que se cargue el juego, la semilla de número aleatorio se regenera. Esto quiere decir que si recargas el juegoo, algunos resultados aleatorios y decisiones de la IA pueden ser diferentes a la primera vez que jugaste.'
  ...
  INSERT INTO Language_es_ES
        (Tag,										Text)
  SELECT		'TXT_KEY_SCIENCE_BOOST_CONQUEST_ASSYRIA',	'Tus soldados encontraron [ICON_RESEARCH] de Ciencia durante la conquista de {1_Name}!'
  ...
  -- Razing
  UPDATE Language_es_ES	
  SET Text = '[COLOR_POSITIVE_TEXT]Razing[ENDCOLOR] La ciudad arderá [ICON_RAZING] cada turno hasta que llegue a 0 Población, cuando será eliminada del juego. Esto producirá bastante [ICON_HAPPINESS_4] Infelicidad, pero también incrementará tu [COLOR_POSITIVE_TEXT]Puntuación de Guerra[ENDCOLOR] contra el antiguo dueño de la ciudad.'
  WHERE Tag = 'TXT_KEY_POPUP_CITY_CAPTURE_INFO_RAZE';

  -- Production Queue
  UPDATE Language_es_ES
  SET Text = 'CLICK IZQUIERDO para añadir un elemento al FINAL de la cola de producción.[NEWLINE]CTRL + CLICK IZQUIERDO para añadir un elemento al INICIO de la cola de producción..[NEWLINE]SHIFT + CLICK IZQUIERDO reemplaza todos los elementos en la cola de producción por el elemento que hayas seleccionado.'
  WHERE Tag = 'TXT_KEY_CITYVIEW_QUEUE_PROD_TT';

  -- Avoid Growth
  UPDATE Language_es_ES
  SET Text = 'Click aquí para detener el crecimiento de [ICON_CITIZEN] Población en esta ciudad.'
  ...
  UPDATE Language_es_ES
  SET Text = '[NEWLINE][ICON_BULLET][ICON_HAPPINESS_1] Modificador de "Amamos el día del Rey": {1_Num}%'
  ...
  -- Capture Chance
  UPDATE Language_es_ES
  SET Text = '[COLOR_CYAN]Chance de captura: {1_Num}%[ENDCOLOR]'
  WHERE Tag = 'TXT_KEY_EUPANEL_CAPTURE_CHANCE';

  -- Interception
  UPDATE Language_es_ES
  SET Text = '[COLOR_WARNING_TEXT]{1_Number} Interceptores![ENDCOLOR]'
