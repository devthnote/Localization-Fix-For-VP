...
WHERE Tag = 'TXT_KEY_PEDIA_PROMOTION_MUST_SET_UP';
 ...
 --(2) Community Balance Overhaul/Balance Changes/Text/es_ES/PromotionText.sql
...
-- Air Ambush - More Interceptions
	...
	--INSERT INTO Language_it_IT (Tag, Text) -- vanila uses the same TXT_KEY for both promos
	--SELECT 'TXT_KEY_PROMOTION_AIR_AMBUSH_2_HELP', Text FROM Language_it_IT WHERE Tag = 'TXT_KEY_PROMOTION_AIR_AMBUSH_1_HELP';
	...
	INSERT INTO Language_it_IT (Tag, Text) -- vanila uses March for this
	...
	UPDATE Language_it_IT
	SET Text = '+25% Chance to [COLOR_POSITIVE_TEXT]Intercept[ENDCOLOR] Enemy Air Units.[NEWLINE]+33% [ICON_STRENGTH] Combat Strength when [COLOR_POSITIVE_TEXT]Intercepting[ENDCOLOR] Enemy aircraft.'
	...
	UPDATE Language_it_IT
	SET Text = '+25% Chance to [COLOR_POSITIVE_TEXT]Intercept[ENDCOLOR] Enemy Air Units.[NEWLINE]+33% [ICON_STRENGTH] Combat Strength when [COLOR_POSITIVE_TEXT]Intercepting[ENDCOLOR] Enemy aircraft. [NEWLINE]+1 operational range.'
...
<!-- Ocean Embarkation Stuff -->
		...
		<Row Tag="TXT_KEY_PROMOTION_DEFENSIVE_DEEPWATER_EMBARKATION_HELP">
			<Text>Permits hovering units to embark at the coastal/ocean boundary. Embarked units receive +100% [ICON_STRENGTH] defensive bonus.</Text>
		</Row>