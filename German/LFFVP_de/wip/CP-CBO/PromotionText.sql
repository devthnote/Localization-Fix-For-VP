...
-- Air Ambush - More Interceptions
	...
	--INSERT INTO Language_de_DE (Tag, Text) -- vanila uses the same TXT_KEY for both promos
	--SELECT 'TXT_KEY_PROMOTION_AIR_AMBUSH_2_HELP', Text FROM Language_de_DE WHERE Tag = 'TXT_KEY_PROMOTION_AIR_AMBUSH_1_HELP';
