...
SET Text = '[COLOR_POSITIVE_TEXT]Arrasar[ENDCOLOR] La ciudad se quemará [ICON_RAZING] cada turno hasta alcanzar 0 población, y ser removida del juego. Esto produce un montón de [ICON_HAPPINESS_4] Infelicidad, pero también incrementa tu [COLOR_POSITIVE_TEXT]Puntuación de Guerra[ENDCOLOR] contra este jugador.'
WHERE Tag = 'TXT_KEY_POPUP_CITY_CAPTURE_INFO_RAZE';

-- Production Queue
UPDATE Language_es_ES
SET Text = 'CLICK IZQ agrega un elemento al final de la cola de producción.[NEWLINE]CTRL + CLICK IZQ agrega un elemento al inicio de la cola de producción.[NEWLINE]SHIFT + CLICK IZQ reemplaza toda la cola de producción por el elemento seleccionado.'
WHERE Tag = 'TXT_KEY_CITYVIEW_QUEUE_PROD_TT';

-- Avoid Growth
UPDATE Language_es_ES
SET Text = 'Click aquí para prevenir que esta ciudad crezca en[ICON_CITIZEN] Población.'
WHERE Tag = 'TXT_KEY_CITYVIEW_FOCUS_AVOID_GROWTH_TT';

-- All Growth Modifier Tooltips with Icons
UPDATE Language_es_ES
SET Text = '[NEWLINE][ICON_BULLET][ICON_CONNECTED] Modificador del Imperio: {1_Num}%'
WHERE Tag = 'TXT_KEY_FOODMOD_PLAYER';

UPDATE Language_es_ES
SET Text = '[NEWLINE][ICON_BULLET][ICON_RELIGION_PANTHEON] Modificador de creencias religiosas: {1_Num}%'
WHERE Tag = 'TXT_KEY_FOODMOD_RELIGION';

UPDATE Language_es_ES
SET Text = '[NEWLINE][ICON_BULLET][ICON_HAPPINESS_1] Modificador de "Día de Amamos al Rey": {1_Num}%'
...
-- City Revolt
UPDATE Language_es_ES
SET Text = 'Debido a que el Imperio tiene al menos un 34% de [ICON_HAPPINESS_4] Infelicidad (o porque nuestra Opinión Pública es negativa), la ciudad se rebelará en [COLOR_NEGATIVE_TEXT]{1_Turns}[ENDCOLOR] turnos. Basado en los niveles de Infelicidad y presión cultural/ideológica actual la ciudad con más chances de rebelarse es {2_CityName} y se unirá a {3_CivName}. Intenta mantener la felicidad del Imperio fuera de éste rango lo más pronto posible!'
WHERE Tag = 'TXT_KEY_NOTIFICATION_POSSIBLE_CITY_REVOLT';

UPDATE Language_es_ES
SET Text = 'Debido a que tu Imperio tiene al menos un 34% de [ICON_HAPPINESS_4] Infelicidad, la ciudad de {1_CityName} se ha rebelado y unido a {2_CivName}!'
WHERE Tag = 'TXT_KEY_NOTIFICATION_CITY_REVOLT';

UPDATE Language_es_ES
SET Text = 'Debido a que tu Imperio tiene al menos un 34% de [ICON_HAPPINESS_4] Infelicidad, ha ocurrido un levantamiento en nuestro territorio!'
WHERE Tag = 'TXT_KEY_NOTIFICATION_REBELS';

---------------------------
------- more stuff need reorder
---------------------------

UPDATE Language_es_ES
SET Text = 'Finaliza después del:  [NEWLINE]Turno {1_turn}'
WHERE Tag = 'TXT_KEY_DO_ENDS_ON';

UPDATE Language_es_ES
SET Text = 'MOVER UNIDAD'
WHERE Tag = 'TXT_KEY_MOVE_STACKED_UNIT';

UPDATE Language_es_ES
SET Text = 'Mueve la unidad a una casilla donde pueda terminar el turno. '
WHERE Tag = 'TXT_KEY_MOVE_STACKED_UNIT_TT';

-- New

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_CO_CITY_TOURISM_GA_BONUS', '{1_Num} [ICON_TOURISM] Turismo de {2_Num}% de la [ICON_CULTURE] Cultura de tu [ICON_CAPITAL] Capital'
