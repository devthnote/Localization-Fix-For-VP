...
SET Text = 'Liberaste su Capital original.'
WHERE Tag = 'TXT_KEY_DIPLO_LIBERATED_CAPITAL';
-- Recent Trade
UPDATE Language_es_ES
SET Text = 'Hemos comerciado recientemente.'
WHERE Tag = 'TXT_KEY_DIPLO_TRADE_PARTNER';
-- Shared Intrigue
UPDATE Language_es_ES
SET Text = 'Haz compartido algunas intrigas con ellos.'
WHERE Tag = 'TXT_KEY_DIPLO_SHARED_INTRIGUE';
-- Diplo Assistance
UPDATE Language_es_ES
SET Text = 'Les favorece tus acciones diplomáticas.'
WHERE Tag = 'TXT_KEY_DIPLO_ASSISTANCE_TO_THEM';

UPDATE Language_es_ES
SET Text = 'Les desilusiona tus acciones diplomáticas.'
WHERE Tag = 'TXT_KEY_DIPLO_REFUSED_REQUESTS';
-- Issues of Dispute
UPDATE Language_es_ES
SET Text = 'Las disputas de territorio entorpecen la relación.'
WHERE Tag = 'TXT_KEY_DIPLO_LAND_DISPUTE';

UPDATE Language_es_ES
SET Text = 'Estás compitiendo por Maravillas.'
WHERE Tag = 'TXT_KEY_DIPLO_WONDER_DISPUTE';
-- Reckless Expansion
UPDATE Language_es_ES
SET Text = 'Ellos creen que estas expandiendo tu Imperio muy agresivamente!'
WHERE Tag = 'TXT_KEY_DIPLO_RECKLESS_EXPANDER';
-- Spying
UPDATE Language_es_ES
SET Text = 'Les pediste que no te espíen.'
WHERE Tag = 'TXT_KEY_DIPLO_STOP_SPYING_ASKED';

UPDATE Language_es_ES
SET Text = 'Atraparon a uno de tus espías robandoles.'
WHERE Tag = 'TXT_KEY_DIPLO_CAUGHT_STEALING';
-- Promises
UPDATE Language_es_ES
SET Text = 'Rompiste tu promesa de no conquistar una Ciudad Estado protegida por ellos!'
WHERE Tag = 'TXT_KEY_DIPLO_CITY_STATE_PROMISE';

UPDATE Language_es_ES
SET Text = 'Rompiste tu promesa de no conquistar una Ciudad Estado protegida por otra civilización!'
WHERE Tag = 'TXT_KEY_DIPLO_CITY_STATE_PROMISE_BROKEN_WITH_OTHERS';

UPDATE Language_es_ES
SET Text = 'Te han pedido que dejes de atacar una Ciudad Estado protegida por ellos y los haz ignorado!'
WHERE Tag = 'TXT_KEY_DIPLO_CITY_STATE_PROMISE_IGNORED';

UPDATE Language_es_ES
SET Text = 'Rompiste tu promesa de iniciar una guerra cooperativa contra otra civilización!'
WHERE Tag = 'TXT_KEY_DIPLO_COOP_WAR_PROMISE';

UPDATE Language_es_ES
SET Text = 'Te han pedido que dejes de expandirte cerca de ellos y los haz ignorado!'
WHERE Tag = 'TXT_KEY_DIPLO_EXPANSION_PROMISE_IGNORED';

UPDATE Language_es_ES
SET Text = 'Te han pedido que dejes de espiarlos y los haz ignorado!'
WHERE Tag = 'TXT_KEY_DIPLO_SPY_PROMISE_IGNORED';

UPDATE Language_es_ES
SET Text = 'Rompiste tu promesa de no declararles la guerra!'
WHERE Tag = 'TXT_KEY_DIPLO_MILITARY_PROMISE';

UPDATE Language_es_ES
SET Text = 'Rompiste tu promesa de no declararle la guerra a otra civilización!'
WHERE Tag = 'TXT_KEY_DIPLO_MILITARY_PROMISE_BROKEN_WITH_OTHERS';

UPDATE Language_es_ES
SET Text = 'Rompiste tu promesa de dejar de excavar sus Artefactos!'
WHERE Tag = 'TXT_KEY_DIPLO_NO_DIG_PROMISE_BROKEN';
-- Friend Betrayal
UPDATE Language_es_ES
SET Text = 'Los hemos denunciado cuando teníamos una declaración de amistad!'
WHERE Tag = 'TXT_KEY_DIPLO_HUMAN_FRIEND_DENOUNCED';

UPDATE Language_es_ES
SET Text = 'Les hemos declarado la guerra cuando teníamos una declaración de amistad!'
WHERE Tag = 'TXT_KEY_DIPLO_HUMAN_FRIEND_DECLARED_WAR';

-- Promises
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_MILITARY_PROMISE_TURNS',	'Prometiste no declararles la guerra por {1_Num} turnos más.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_EXPANSION_PROMISE_TURNS',	'Prometiste no asentarte cerca de ellos por {1_Num} turnos más.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_BORDER_PROMISE_TURNS',	'Prometiste no comprar tierras cerca de ellos por {1_Num} turnos más.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_AI_MILITARY_PROMISE_TURNS',	'Prometieron no declararnos la guerra por {1_Num} turnos más.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_AI_EXPANSION_PROMISE_TURNS',	'Prometieron no asentarse cerca de nosotros por {1_Num} turnos más.';
-- Opinion Indicator for Human Teammate 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_HUMAN_TEAMMATE',	'[COLOR_POSITIVE_TEXT]Estamos en el mismo equipo.[ENDCOLOR]';
-- Opinion Indicators For Neutral Approach 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_NEUTRAL_FRIENDLY',	'No tienen sentimientos fuertes hacia nosotros de una forma u otra. ';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_NEUTRAL_HOSTILE',	'No nos consideran relevantes para sus intereses.';
-- Opinion Indicator If Untrustworthy 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_UNTRUSTWORTHY_FRIEND',	'Somos completamente poco confiables para ellos.';
-- Base Opinion Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_VERY_GOOD_BASE_OPINION',	'Les gustas instintivamente!';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_GOOD_BASE_OPINION',	'Instintivamente te ven más favorablemente.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_BAD_BASE_OPINION',	'Instintivamente te ven como un competidor. ';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_VERY_BAD_BASE_OPINION',	'Te odian instintivamente!';

-- Embassy Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_MUTUAL_EMBASSY',	'Hemos compartido Embajadas.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_WE_HAVE_EMBASSY',	'Tenemos una Embajada en su capital.';

-- Open Borders Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_OPEN_BORDERS_MUTUAL',	'Hemos abierto fronteras mutuamente';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_OPEN_BORDERS_US',	'Hemos abierto nuestras fronteras para ellos.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_OPEN_BORDERS_THEM',	'Han abierto sus fronteras para nosotros.';

-- Defensive Pact Diplo Mods 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DP',	'Hemos hecho un pacto defensivo!';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DP_MUTUAL',	'Hemos hecho un pacto defensivo con los mismos líderes!';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DP_WITH_ENEMY',	'Hiciste un Pacto Defensivo con uno de sus enemigos!';
-- Research Agreement Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_MADE_RESEARCH_AGREEMENT',	'Tenemos un acuerdo de investigación!';
-- Denouncement Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_MUTUAL_DENOUNCEMENT',	'Nos hemos denunciado mutuamente!';
-- Tech Dispute Mod (for scientific civs) 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TECH_DISPUTE',	'Estás compitiendo por avance Tecnológico.';
-- Non-Competition Diplo Mods 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_NO_WONDER_DISPUTE',	'No estás compitiendo por Maravillas.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_NO_MINOR_CIV_DISPUTE',	'No estás compitiendo por el favor de las mismas Ciudades Estado.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_NO_TECH_DISPUTE',	'No estás compitiendo por avance Tecnológico.';
-- Wonder Spammer Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_WONDER_SPAMMER',	'Creen que estamos construyendo Maravillas muy agresivamente!';
-- Social Policies Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_SAME_POLICIES',	'Tenemos políticas sociales similares.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DIFFERENT_POLICIES',	'Tenemos políticas sociales diferentes.';
-- PTP Same CS Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_SAME_PTP',	'Hemos prometido protección a las mismas Ciudades Estado.';
-- Same Master Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_SAME_MASTER',	'Somos vasallos del mismo Amo!';
-- Stolen Artifacts Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_STOLEN_ARTIFACTS',	'Excavaste sus Artefactos Culturales!';
-- Plotted Against Them Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_PLOTTED_AGAINST_US',	'Te atraparon conspirando contra ellos!';


-- City-State Coup Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_PERFORMED_COUP',	'Nuestros espías usurparon su alianza con una Ciudad Estado en un Golpe de Estado.';


-- Aggressive Posture Diplo Mod 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_AGGRESSIVE_POSTURE_MEDIUM',	'Tu despliegue militar es amenazador.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_AGGRESSIVE_POSTURE_HIGH',	'Tu despliegue militar es extremadamente amenazador.';


-- Religion Diplo Mods 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_SAME_MAJORITY_RELIGIONS',	'Hemos adoptado la misma religión en la mayoría de nuestras ciudades.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_RELIGIOUS_DIFFERENCES',	'Las diferencias religiosas tensan la relación.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_RELIGIOUS_DIFFERENCES_NEUTRAL',	'Tenemos diferentes creencias religiosas.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_CAPTURED_HOLY_CITY',	'Capturaste su Ciudad Santa!';


-- Ideology Diplo Mods 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_SAME_LATE_POLICY_TREES_VASSAL',	'Ambos hemos adoptado la ideología de {1_PolicyTree}.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DIFFERENT_LATE_POLICY_TREES_VASSAL',	'Adoptaste la ideología de {1_YourPolicyTree}, pero ellos creen en el {2_TheirPolicyTree}.';


-- World Congress >>> United Nations 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_LIKED_OUR_PROPOSAL_UN',	'Les ha gustado nuestra propuesta a las Naciones Unidas.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DISLIKED_OUR_PROPOSAL_UN',	'No les ha gustado nuestra propuesta a las Naciones Unidas.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_SUPPORTED_THEIR_PROPOSAL_UN',	'Les ayudamos a aprobar su propuesta en las Naciones Unidas.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_FOILED_THEIR_PROPOSAL_UN',	'Ayudamos a que su propuesta fracasara en las Naciones Unidas.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_SUPPORTED_THEIR_HOSTING_UN',	'Les ayudamos a convertirse en anfitriones de las Naciones Unidas.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_VICTORY_DISPUTE_CBP_WEAK',	'[COLOR_NEGATIVE_TEXT]Temen que estés compitiendo con ellos.[ENDCOLOR]';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_VICTORY_DISPUTE_CBP_STRONG',	'[COLOR_NEGATIVE_TEXT]Sospechan que estás compitiendo con ellos.[ENDCOLOR]';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_VICTORY_DISPUTE_CBP_FIERCE',	'[COLOR_NEGATIVE_TEXT]¡Saben que estás compitiendo con ellos y lo odian![ENDCOLOR]';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_VICTORY_BLOCK_FIERCE',	'[COLOR_NEGATIVE_TEXT]Tu comportamiento les enfurece[ENDCOLOR]';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_VICTORY_BLOCK_STRONG',	'[COLOR_NEGATIVE_TEXT]Tu comportamiento les Irrita[ENDCOLOR]';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_VICTORY_BLOCK_WEAK',	'[COLOR_NEGATIVE_TEXT]Tu comportamiento les preocupa.[ENDCOLOR]';
-- Razing 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_RAZED',	'[COLOR_NEGATIVE_TEXT]Asesinaste o esclavizaste a alguno(s) de sus civiles![ENDCOLOR]';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_RAZED_OTHER',	'[COLOR_NEGATIVE_TEXT]Asesinaste o esclavizaste civiles durante la guerra![ENDCOLOR]';
--------------------
-- UI
-------------------
-- Promise Duration
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DURATION_PROMISE',	'Esta promesa durará [COLOR_POSITIVE_TEXT]{1_Num}[ENDCOLOR] Turnos. Si violas esta promesa durante ese tiempo, el jugador se sentirá Traicionado!';

-- Diplomacy Screen Buttons 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_NEGOTIATE_PEACE_BLOCKED_THEM_TT',	'No pueden negociar la Paz por {1_Num} turno(s) debido a un trato que relizaron con otro jugador.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_NEGOTIATE_PEACE_BLOCKED_MOD_TT',	'Siempre estás en guerra con este jugador!';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_MAY_NOT_ATTACK_VASSAL',	'No puedes declarar la guerra a un vasallo de otra civilización (debes declarar la guerra al Amo del vasallo, {1_CivName}).';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DECLARE_WAR_VASSAL_BLOCKED_TT',	'No puedes declarar la guerra cómo vasallo  (la  guerra se declara automáticamente cuando tu Amo le declare la guerra a esta civilización).';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DECLARE_WAR_VASSAL_BLOCKED_MASTER_TT',	'No puedes declarle la guerra a tu Amo hasta que solicites la Independencia o seas Liberado.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_MAY_NOT_MAKE_PEACE_VASSAL',	'No puedes negociar la Paz con el vasallo de otra civilización (debes negociar la paz con su Amo, {1_CivName}).';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_NEGOTIATE_PEACE_VASSAL_BLOCKED_TT',	'No puedes negociar la paz como vasallo (La paz se negocia automáticamente cuando tu Amo la negocie).';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_DEMAND_BUTTON_TT',	'Exigir tributo a esta civilización. Esta opción lleva una penalización diplomática.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_REQUEST_HELP_BUTTON',	'Pedir Ayuda';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_REQUEST_HELP_BUTTON_TT',	'Pedir ayuda a un jugador con el que tienes una declaración de amistad pública. Esta opción no lleva ninguna penalización diplomática.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_REQUEST_HELP_DEAL_BUTTON',	'PEDIR';
-- Regular Deal Details
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRADE_VALUE_STR_PEACE',	'Valor del trato para ellos: {1_Num}.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRADE_VALUE_STR_PEACE_IMPOSSIBLE',	'Valor del trato para ellos: Imposible!';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRADE_VALUE_STR_PEACE_EMBARGO',	'SANCIONADO POR EL CONGRESO MUNDIAL';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRADE_VALUE_STR_PEACE_EMBARGO_TT',	'No puedes hacer tratos durante tiempos de paz con esta Civilización hasta que se levante la Sanción.';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRADE_VALUE_STR_PEACE_ACCEPTABLE',	'Valor del trato para ellos: Aceptable';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRADE_VALUE_STR_PEACE_TT',	'Valor actual del intercambio para la IA. Si el valor aquí es ''Imposible'' o muy negativo, la IA rechazará el trato.';


-- Show True Approach Debug Text 
INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRUE_APPROACH_WAR',	'Enfoque Verdadero: Guerra';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRUE_APPROACH_PLANNING_WAR',	'Enfoque Verdadero: Planeando una guerra';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRUE_APPROACH_HOSTILE',	'Enfoque Verdadero: Hóstil';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRUE_APPROACH_DECEPTIVE',	'Enfoque Verdadero: Engañoso';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRUE_APPROACH_GUARDED',	'Enfoque Verdadero: A la defensiva';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRUE_APPROACH_AFRAID',	'Enfoque Verdadero: Temeroso';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRUE_APPROACH_FRIENDLY',	'Enfoque Verdadero: Amistoso';

INSERT INTO Language_es_ES (Tag, Text)
SELECT 'TXT_KEY_DIPLO_TRUE_APPROACH_NEUTRAL',	'Enfoque Verdadero: Neutral';
...
-- Generic
UPDATE Language_es_ES
SET Text = 'Hola, amigo ¿Que te trae a mi corte hoy?'
WHERE Tag = 'TXT_KEY_GENERIC_GREETING_POLITE_HELLO_1';

UPDATE Language_es_ES
SET Text = 'Hola nuevamente, amigo mío.'
WHERE Tag = 'TXT_KEY_GENERIC_GREETING_POLITE_HELLO_3';

UPDATE Language_es_ES
SET Text = 'Seguro que te gusta hablar conmigo, ¿No es así?'
WHERE Tag = 'TXT_KEY_GENERIC_GREETING_REPEAT_2';

UPDATE Language_es_ES
SET Text = 'Tu reciente tendencia de comprar tierras cercanas a nosotros es preocupante. En aras del futuro de nuestra relación, Your recent trend of buying land near us is concerning. For the sake of our future relationship, Te aconsejo que seas cauteloso(a) en este asunto. Ahora que ya está dicho ¿Qué te trae por aquí hoy?'
WHERE Tag = 'TXT_KEY_GENERIC_GREETING_AGGRESSIVE_PLOT_BUYING_1';

UPDATE Language_es_ES
SET Text = 'La propagación de tus ciudades y tu gente es como una plaga que infecta la tierra. Espero con ansias el día en que ya no tenga que verlo.'
WHERE Tag = 'TXT_KEY_GENERIC_GREETING_HOSTILE_AGGRESSIVE_EXPANSION_1';

UPDATE Language_es_ES
SET Text = 'Entre tú y yo, tu ejército es el hazmerreír del mundo. Sin embargo, no dejes que eso te deprima; Estoy seguro de que alguien te sacará pronto de tu miseria.'
WHERE Tag = 'TXT_KEY_GENERIC_GREETING_HOSTILE_HUMAN_SMALL_ARMY';

UPDATE Language_es_ES
SET Text = 'Creo que un acuerdo de investigación es un beneficio mutuo que ayudaría a consolidar nuestra amistad.'
WHERE Tag = 'TXT_KEY_GENERIC_RESEARCH_AGREEMENT_OFFER_1';

UPDATE Language_es_ES
SET Text = 'No podemos ofrecerte lo suficiente para que este sea un intercambio justo. Sin embargo, podemos ofrecerte este trato. '
WHERE Tag = 'TXT_KEY_GENERIC_TRADE_CANT_MATCH_OFFER_1';

UPDATE Language_es_ES
SET Text = 'El trato que sugerimos puede ser un intercambio injusto para tí. Por favor, inspeccionalo de cerca. '
WHERE Tag = 'TXT_KEY_GENERIC_TRADE_CANT_MATCH_OFFER_2';

UPDATE Language_es_ES
SET Text = 'Este acuerdo no es del todo aceptable. Si deseas que lleguemos a alguna parte, deberías ofrecernos un trato justo.'
WHERE Tag = 'TXT_KEY_GENERIC_TRADE_REJECT_INSULTING_1';

UPDATE Language_es_ES
SET Text = 'Desafortunadamente, las cosas no van muy bien aquí. ¿Puedes dejar algo para un amigo? Intentaré devolver el favor cuando las cosas me vayan mejor.'
WHERE Tag = 'TXT_KEY_GENERIC_REQUEST_ITEM_1';

UPDATE Language_es_ES
SET Text = 'Tienes algo que quiero. Si no me lo entregas por las buenas, no tendré más remedio que tomarlo por la fuerza. '
WHERE Tag = 'TXT_KEY_GENERIC_DEMAND_1';

UPDATE Language_es_ES
SET Text = '¿Cómo te atreves a insultarme de esa manera? Si deseas algo tan desesperadamente, has todo lo posible por venir y tomarlo.'
WHERE Tag = 'TXT_KEY_GENERIC_HUMAN_DEMAND_REFUSE_HOSTILE_1';

UPDATE Language_es_ES
SET Text = 'Si quieres eso, deberás venir y tomarlo.'
WHERE Tag = 'TXT_KEY_GENERIC_HUMAN_DEMAND_REFUSE_HOSTILE_3';

UPDATE Language_es_ES
SET Text = 'Veo tus ejércitos reunidos cerca de mi imperio. Si quieres atacar, ven. No te escondas en las sombras como un niño.'
WHERE Tag = 'TXT_KEY_HOSTILE_AGGRESSIVE_MILITARY_WARNING_1';

UPDATE Language_es_ES
SET Text = 'Tu agresión sin motivo a {@1_MinorCivName} no ha pasado desapercibida. Enfrentarás graves consecuencias si continúas con tu asalto. '
WHERE Tag = 'TXT_KEY_ATTACKED_PROTECTED_CITY_STATE_1';

UPDATE Language_es_ES
SET Text = 'Me ha llamado la atención que pude haber atacado una ciudad-estado con la que has tenido relaciones pasadas. Si bien no era mi objetivo estar en desacuerdo con tu imperio, esto se consideró un curso de acción necesario.'
WHERE Tag = 'TXT_KEY_WE_ATTACKED_YOUR_MINOR_1';

UPDATE Language_es_ES
SET Text = 'Me han informado de que mi imperio ha comenzado un ataque contra una ciudad-estado amiga tuya. Te aseguro que esto no fue a propósito, y espero que el malentendido no sirva para separarnos. '
WHERE Tag = 'TXT_KEY_WE_ATTACKED_YOUR_MINOR_2';

UPDATE Language_es_ES
SET Text = 'Entonces, ¿así es como será? Muy bien. No olvidaré esto.'
WHERE Tag = 'TXT_KEY_RESPONSE_TO_BEING_DENOUNCED_1';

UPDATE Language_es_ES
SET Text = '¿Entonces ese es el tipo de aliado que eres? El resto de los líderes del mundo se enterarán de tu traición. [NEWLINE][NEWLINE]([COLOR_WARNING_TEXT]Nos han denunciado! NOTA: No estás en guerra.[ENDCOLOR])'
WHERE Tag = 'TXT_KEY_DOF_NOT_HONORED_2';

UPDATE Language_es_ES
SET Text = 'Declararnos la guerra fue un grave error de juicio de tu parte. Dicho esto, no dudaré en hacer que te arrepientas. '
WHERE Tag = 'TXT_KEY_GENERIC_ATTACKED_STRONG_HOSTILE_4';

UPDATE Language_es_ES
SET Text = 'Tenía la sensación de que los dos nos encontraríamos algún día en el campo de batalla. Ahora veremos cuál de nosotros está destinado a salir victorioso. '
WHERE Tag = 'TXT_KEY_GENERIC_DOW_GENERIC_2';

UPDATE Language_es_ES
SET Text = 'Es hora de luchar. Que gane el mejor.'
WHERE Tag = 'TXT_KEY_GENERIC_DOW_GENERIC_3';

UPDATE Language_es_ES
SET Text = 'La destrucción podría ser el destino que me aguarda, pero si retrocedo, de todos modos solo me espera una eventual derrota. '
WHERE Tag = 'TXT_KEY_GENERIC_DOW_DESPERATE_8';

UPDATE Language_es_ES
SET Text = 'Creo que en otra vida, los dos podríamos haber sido amigos. Desafortunadamente, ahora no es así. Le deseo suerte a tu ejército. '
WHERE Tag = 'TXT_KEY_GENERIC_DOW_REGRET_1';

UPDATE Language_es_ES
SET Text = 'Que así sea. Mis ejércitos lo sacarán de tus tierras, entonces.'
WHERE Tag = 'TXT_KEY_WAR_DEMAND_REFUSED_1';

UPDATE Language_es_ES
SET Text = 'Entonces, no tengo más negocios con gente como tú.'
WHERE Tag = 'TXT_KEY_GENERIC_HUMAN_RESPONSE_BAD_2';

UPDATE Language_es_ES
SET Text = 'No pude evitar notar lo patético que eres. Y cuando me di cuenta, no pude evitar compartirlo.'
WHERE Tag = 'TXT_KEY_GENERIC_INSULT_GENERIC_1';

UPDATE Language_es_ES
SET Text = 'Con un ejército tan débil como el tuyo, es una sorpresa que tu imperio no haya sucumbido a una invasión bárbara.'
WHERE Tag = 'TXT_KEY_GENERIC_INSULT_MILITARY_2';

UPDATE Language_es_ES
SET Text = 'Puedo escuchar a tu gente llorando de dolor en todo mi Imperio. Si no haces algo pronto, es posible que hagan las maletas y encuentren una civilización real en la que vivir.'
WHERE Tag = 'TXT_KEY_GENERIC_INSULT_UNHAPPINESS_1';

UPDATE Language_es_ES
SET Text = 'Con tu gente tan infeliz, me sorprende que te mantengan como su líder. '
WHERE Tag = 'TXT_KEY_GENERIC_INSULT_UNHAPPINESS_2';

UPDATE Language_es_ES
SET Text = 'Los viajeros nos han dicho que la economía de tu imperio está en muy mal estado. Si ruegas un poco, podría echarte una mano. De acuerdo, de hecho, no lo haré.'
WHERE Tag = 'TXT_KEY_GENERIC_INSULT_POPULATION_1';

UPDATE Language_es_ES
SET Text = 'Imposible. Has ido demasiado lejos.'
WHERE Tag = 'TXT_KEY_DIPLO_DISCUSS_HOW_DARE_YOU';

UPDATE Language_es_ES
SET Text = 'Nuestra Declaración de Amistad debe terminar.'
WHERE Tag = 'TXT_KEY_DIPLO_DISCUSS_MESSAGE_END_WORK_WITH_US';

UPDATE Language_es_ES
SET Text = 'Tus acciones son imperdonables. Nunca podrá haber reconciliación entre nuestras dos naciones.[NEWLINE][NEWLINE] (Ya no eres su amigo. Si denuncias a este jugador o le declaras la guerra en los próximos [COLOR_WARNING_TEXT]10[ENDCOLOR] turnos, recibirás una sanción diplomática por apuñalarlos por la espalda.) '
WHERE Tag = 'TXT_KEY_NOW_UNFORGIVABLE_1';

UPDATE Language_es_ES
SET Text = 'No quería que las cosas acabaran así, pero no puedo pasar por alto tu belicismo. Considera nuestra Declaración de Amistad Finalizada. '
WHERE Tag = 'TXT_KEY_END_WORK_WITH_US_WARMONGER_1';

UPDATE Language_es_ES
SET Text = 'Tus tratos con las ciudades-estado de mi esfera de influencia son inaceptables. Considera nuestra Declaración de Amistad Finalizada.'
WHERE Tag = 'TXT_KEY_END_WORK_WITH_US_MINORS_1';

UPDATE Language_es_ES
SET Text = 'Me temo que nuestra proximidad estaba destinada a envenenar nuestra relación. Considera nuestra Declaración de Amistad Finalizada.'
WHERE Tag = 'TXT_KEY_END_WORK_WITH_US_LAND_1';

UPDATE Language_es_ES
SET Text = 'Tu continua codicia por coleccionar maravillas del mundo se ha convertido en un problema importante.  Considera nuestra Declaración de Amistad Finalizada.'
WHERE Tag = 'TXT_KEY_END_WORK_WITH_US_WONDERS_1';

UPDATE Language_es_ES
SET Text = 'Ahora tengo claro que los caminos que recorremos deben, en última instancia, separarnos. Considera nuestra Declaración de Amistad Finalizada.'
WHERE Tag = 'TXT_KEY_END_WORK_WITH_US_VICTORY_1';

UPDATE Language_es_ES
SET Text = 'Las circunstancias han cambiado y creo que ya no es necesario que continúe nuestra Declaración de Amistad. Espero que puedas entender.'
WHERE Tag = 'TXT_KEY_END_WORK_WITH_US_DEFAULT_1';

UPDATE Language_es_ES
SET Text = 'Lo siento, pero es hora de que termine nuestra Declaración de Amistad.'
